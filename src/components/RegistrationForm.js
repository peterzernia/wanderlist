    ...
    return(
      <div className='form-inline'>
        <form onSubmit={this.props.handleSubmit}>
          ...
          <InputLabel disableAnimation={false} htmlFor="country">Home Country</InputLabel>
          <Select style={{ textAlign: 'left', width: 300 }} name="country" onChange={this.handleChange} value={this.state.country}>
