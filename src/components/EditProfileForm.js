...
const EditProfileForm = (props) => (
  <form onSubmit={props.handleSubmit}>
    <TextField className="user-auth" type='text' label='Username' name="username" defaultValue={props.user.username}/><br/>
    <TextField className="user-auth" type='text' label='Email' name="email" defaultValue={props.user.email}/><br/>
    <TextField select className="user-auth" label='Home Country' name="country" value={props.user.home}>
