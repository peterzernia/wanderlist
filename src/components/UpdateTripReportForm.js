      ...
      <div>
        ...
        <div className='form-inline'>
          <form onSubmit={this.props.handleSubmit}>
            <input className="form-control user-auth" type='text' name="title" defaultValue={this.props.modalPost.title}/><br/><br/>
            <textarea className="form-control user-auth" rows="4" cols="100" name="content" defaultValue={this.props.modalPost.content}/><br/><br/>
            <select className="form-control user-auth" name="countries" id="id_countries" multiple="multiple" defaultValue={this.props.modalPost.countries}>
