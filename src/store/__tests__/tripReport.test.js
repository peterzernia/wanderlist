...
describe('tripReport Reducer', () => {
  ...
  it('can handle FETCH_TRIP_REPORTS_PENDING', () => {
    expect(tripReport(undefined, { type: 'FETCH_TRIP_REPORTS_PENDING' })).toEqual({
      ...defaultState,
      fetching: true,
    })
  });
  ...
  it('can handle FETCH_TRIP_REPORTS_FULFILLED', () => {
    expect(tripReport(undefined, {
      type: 'FETCH_TRIP_REPORTS_FULFILLED',
      tripReports: { results: [tripReportObject], count: 1, next: null, previous: null}
    })).toEqual({
      ...defaultState,
      fetching: false,
      fetched: true,
  ...
  it('can handle FETCH_TRIP_REPORTS_REJECTED', () => {
    expect(tripReport(undefined, { type: 'FETCH_TRIP_REPORTS_REJECTED' })).toEqual({
      ...defaultState,
      fetching: false,
      fetched: false
    })
  ...
  it('can handle FETCH_NEXT_TRIP_REPORTS_PENDING', () => {
    expect(tripReport(undefined, { type: 'FETCH_NEXT_TRIP_REPORTS_PENDING' })).toEqual({
      ...defaultState,
      fetchingNext: true,
      fetchedNext: false,
    })
  ...
  it('can handle FETCH_NEXT_TRIP_REPORTS_FULFILLED', () => {
      ...
      {...defaultState, tripReports: { results: [tripReportObject] }},
    {
      ...
      tripReports: { results: [tripReportObject, tripReportObject], count: undefined, next: undefined, previous: undefined }
    })
    ...
    expect(tripReport(undefined,
    {
      ...
      tripReports: { results: [tripReportObject], count: undefined, next: undefined, previous: undefined }
    })
  });

  it('can handle FETCH_NEXT_TRIP_REPORTS_REJECTED', () => {
    expect(tripReport(undefined, { type: 'FETCH_NEXT_TRIP_REPORTS_REJECTED' })).toEqual({
      ...defaultState,
      fetchingNext: false,
      fetchedNext: false,
    })
  ...
  it('can handle FETCH_USER_TRIP_REPORTS_PENDING', () => {
    expect(tripReport(undefined, { type: 'FETCH_USER_TRIP_REPORTS_PENDING' })).toEqual({
      ...defaultState,
  ...
  it('can handle FETCH_USER_TRIP_REPORTS_FULFILLED', () => {
    expect(tripReport(undefined, {
      ...
      userTripReports: { results: [tripReportObject], count: 1, next: null, previous: null},
    })
  });

  it('can handle FETCH_USER_TRIP_REPORTS_REJECTED', () => {
    expect(tripReport(undefined, { type: 'FETCH_USER_TRIP_REPORTS_REJECTED' })).toEqual({
      ...defaultState,
      fetchingTripReports: false,
      fetchedTripReports: false,
    })
  ...
  it('can handle FETCH_NEXT_USER_TRIP_REPORTS_PENDING', () => {
    expect(tripReport(undefined, { type: 'FETCH_NEXT_USER_TRIP_REPORTS_PENDING' })).toEqual({
      ...defaultState,
  ...
  it('can handle FETCH_NEXT_USER_TRIP_REPORTS_FULFILLED', () => {
      ...
      {...defaultState, userTripReports: { results: [tripReportObject] }},
    {
      ...
      // Here the results array is now two trip reports
      userTripReports: { results: [tripReportObject, tripReportObject], count: undefined, next: undefined, previous: undefined }
    })
    ...
    expect(tripReport(undefined,
    {
      ...
      fetchedUserNext: true,
      // Here the results array is now one trip report
      userTripReports: { results: [tripReportObject], count: undefined, next: undefined, previous: undefined }
    })
  });

  it('can handle FETCH_NEXT_USER_TRIP_REPORTS_REJECTED', () => {
    expect(tripReport(undefined, { type: 'FETCH_NEXT_USER_TRIP_REPORTS_REJECTED' })).toEqual({
      ...defaultState,
      fetchingUserNext: false,
      fetchedUserNext: false,
    })
  ...
  it('can handle POST_TRIP_REPORTS_PENDING', () => {
    expect(tripReport(undefined, { type: 'POST_TRIP_REPORTS_PENDING' })).toEqual({
      ...defaultState,
      posting: true,
    })
  });
  ...
  it('can handle POST_TRIP_REPORTS_FULFILLED', () => {
    ...
    expect(tripReport(undefined,
    {
      ...
      ...defaultState,
      posting: false,
      userTripReports: { results: [tripReportObject], count: null, next: null, previous: null },
      tripReports: { results: [tripReportObject], count: null, next: null, previous: null }
    })
    ...
    },
    {
      ...
      ...defaultState,
      posting: false,
      userTripReports: { results: [tripReportOne, tripReportObject], count: undefined, next: undefined, previous: undefined },
      tripReports: { results: [tripReportOne, tripReportObject], count: undefined, next: undefined, previous: undefined }
    })
  });

  it('can handle POST_TRIP_REPORTS_REJECTED', () => {
    expect(tripReport(undefined, { type: 'POST_TRIP_REPORTS_REJECTED' })).toEqual({
      ...defaultState,
      posting: false,
    })
  });
  ...
  it('can handle DELETE_TRIP_REPORTS_FULFILLED', () => {
    ...
    },
    {
      ...
      userTripReports: { results: [], count: undefined, next: undefined, previous: undefined },
      tripReports: { results: [], count: undefined, next: undefined, previous: undefined }
    })
  });

  it('can handle UPDATE_TRIP_REPORTS_PENDING', () => {
    expect(tripReport(undefined, { type: 'UPDATE_TRIP_REPORTS_PENDING' })).toEqual({
      ...defaultState,
      updating: true,
    })
  });
  ...
  it('can handle UPDATE_TRIP_REPORTS_FULFILLED', () => {
    ...
    },
    {
      ...
      userTripReports: { results: [updatedTripReport, otherTripReport], count: undefined, next: undefined, previous: undefined },
      tripReports: { results: [updatedTripReport, otherTripReport], count: undefined, next: undefined, previous: undefined }
    })
  });

  it('can handle UPDATE_TRIP_REPORTS_REJECTED', () => {
    expect(tripReport(undefined, { type: 'UPDATE_TRIP_REPORTS_REJECTED' })).toEqual({
      ...defaultState,
      updating: false,
    })
  });
  ...
  it('can handle FETCH_SLUG_TRIP_REPORTS_PENDING', () => {
    expect(tripReport(undefined, { type: 'FETCH_SLUG_TRIP_REPORTS_PENDING' })).toEqual({
      ...defaultState,
  ...
  it('can handle FETCH_SLUG_TRIP_REPORTS_REJECTED', () => {
    expect(tripReport(undefined, { type: 'FETCH_SLUG_TRIP_REPORTS_REJECTED' })).toEqual({
      ...defaultState,
      fetchingSlugTripReports: false,
      fetchedSlugTripReports: false,
    })
  ...
  it('can handle FETCH_FEATURED_TRIP_REPORT_PENDING', () => {
    expect(tripReport(undefined, { type: 'FETCH_FEATURED_TRIP_REPORT_PENDING' })).toEqual({
      ...defaultState,
  ...
  it('can handle FETCH_FEATURED_TRIP_REPORT_REJECTED', () => {
    expect(tripReport(undefined, { type: 'FETCH_FEATURED_TRIP_REPORT_REJECTED' })).toEqual({
      ...defaultState,
      fetchingFeaturedTripReport: false,
      fetchedFeaturedTripReport: false,
    })
  ...
  it('can handle TOGGLE_FAVORITE_FULFILLED', () => {
    ...
    expect(tripReport({
      // Set default state.
      ...defaultState,
      tripReports: { results: [tripReportObject, otherTripReport], count: null, next: null, previous: null  },
      slugTripReports: [tripReportObject],
      featuredTripReport: [tripReportObject]
    }, {
      ...
      tripReports: { results: [favoritedTripReport, otherTripReport], count: null, next: null, previous: null },
  ...
  it('can handle PUT_USER_DATA_FULFILLED', () => {
    ...
    expect(tripReport({
      ...
      ...defaultState,
      tripReports: { results: [updatedTripReport, otherTripReport], count: null, next: null, previous: null  },
    })
  });
