  ...
  */
  ...
  return(
    <form onSubmit={handleSubmit}>
      <TextField className="user-auth" type='text' name="title" label="Title" onChange={handleChange} value={state.title} required/><br/>
      <TextField multiline fullWidth className="user-auth" type='text' name="content" label="Content" onChange={handleChange} value={state.content} required/><br/>
      <FormControl>
