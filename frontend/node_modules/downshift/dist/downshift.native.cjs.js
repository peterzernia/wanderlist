...
function (_Component) {
  ...
  function Downshift(_props) {
    ...
    _this.getToggleButtonProps = function (_temp3) {
      ...
      {
        onPress: callAllEventHandlers(onPress, _this.button_handleClick)
      };
    ...
    _this.getInputProps = function (_temp4) {
      ...
      eventHandlers = {
        onChange: callAllEventHandlers(onChange, onInput, _this.input_handleChange),
        onChangeText: callAllEventHandlers(onChangeText, onInput, _this.input_handleTextChange),
        onBlur: callAllEventHandlers(onBlur, _this.input_handleBlur)
      };
      return _extends({
