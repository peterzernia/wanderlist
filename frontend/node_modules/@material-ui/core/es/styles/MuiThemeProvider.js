...
MuiThemeProviderOld.propTypes = process.env.NODE_ENV !== "production" ? {
  /**
   * You can wrap a node.
   */
...
MuiThemeProviderOld.propTypes = process.env.NODE_ENV !== "production" ? exactProp(MuiThemeProviderOld.propTypes) : {};
MuiThemeProviderOld.childContextTypes = _objectSpread({}, themeListener.contextTypes, {
  muiThemeProviderOptions: PropTypes.object
});
MuiThemeProviderOld.contextTypes = _objectSpread({}, themeListener.contextTypes, {
  muiThemeProviderOptions: PropTypes.object
});
/* istanbul ignore if */
