  ...
  render() {
    const _this$props = this.props,
      ...
      variant
          ...
          other = _objectWithoutProperties(_this$props, ["avatar", "classes", "className", "clickable", "color", "component", "deleteIcon", "icon", "label", "onClick", "onDelete", "onKeyDown", "onKeyUp", "tabIndex", "variant"]);
