...
function ListItem(props) {
  const {
    ...
    selected
        ...
        other = _objectWithoutProperties(props, ["button", "children", "classes", "className", "component", "ContainerComponent", "ContainerProps", "dense", "disabled", "disableGutters", "divider", "focusVisibleClassName", "selected"]);
